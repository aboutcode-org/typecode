...
from src.typecode._vendor.pygments.style import _ansimap
from src.typecode._vendor.pygments.util import get_bool_opt, get_int_opt, get_list_opt, surrogatepair
