...
from typecode._vendor.pygments.lexer import RegexLexer, include, words, bygroups
from typecode._vendor.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Error

from typecode._vendor.pygments.lexers._openedge_builtins import OPENEDGEKEYWORDS
