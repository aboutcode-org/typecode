...
from src.typecode._vendor.pygments.lexer import ExtendedRegexLexer, include, bygroups, default, \
    words, line_re
from src.typecode._vendor.pygments.token import Comment, Operator, Keyword, Name, String, Number, \
