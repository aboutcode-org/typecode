...
from src.typecode._vendor.pygments.lexer import RegexLexer, bygroups, do_insertions, include, \
    this, using, words
from src.typecode._vendor.pygments.token import Comment, Error, Keyword, Name, Number, Operator, \
    Punctuation, String, Text

from src.typecode._vendor.pygments.util import ClassNotFound, get_bool_opt
