...
from src.typecode._vendor.pygments.lexer import Lexer, RegexLexer, include, bygroups, default, \
...
from src.typecode._vendor.pygments.util import get_bool_opt, get_list_opt, shebang_matches
...
class PhpLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.funcnamehighlighting:
            from src.typecode._vendor.pygments.lexers._php_builtins import MODULES
