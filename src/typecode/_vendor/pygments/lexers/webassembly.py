...
from src.typecode._vendor.pygments.lexer import RegexLexer, words, bygroups, default
from src.typecode._vendor.pygments.token import Text, Comment, Operator, Keyword, String, Number, Punctuation, Name
