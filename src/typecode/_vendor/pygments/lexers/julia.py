...
from src.typecode._vendor.pygments.lexer import Lexer, RegexLexer, bygroups, do_insertions, \
    words, include
from src.typecode._vendor.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Generic, Whitespace
from src.typecode._vendor.pygments.util import shebang_matches
from src.typecode._vendor.pygments.lexers._julia_builtins import OPERATORS_LIST, DOTTED_OPERATORS_LIST, \
