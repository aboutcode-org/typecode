...
from src.typecode._vendor.pygments.lexer import RegexLexer, include, bygroups, using, this
from src.typecode._vendor.pygments.token import Text, Comment, Keyword, String, Generic
