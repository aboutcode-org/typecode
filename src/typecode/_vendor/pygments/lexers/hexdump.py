...
from typecode._vendor.pygments.lexer import RegexLexer, bygroups, include
from typecode._vendor.pygments.token import Text, Name, Number, String, Punctuation
