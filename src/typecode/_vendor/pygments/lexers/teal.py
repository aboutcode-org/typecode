...
from src.typecode._vendor.pygments.lexer import RegexLexer, bygroups, include, words
from src.typecode._vendor.pygments.token import Comment, Name, Number, String, Text, Keyword, \
    Whitespace
