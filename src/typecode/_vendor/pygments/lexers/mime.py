...
from src.typecode._vendor.pygments.lexers import get_lexer_for_mimetype
from src.typecode._vendor.pygments.token import Text, Name, String, Operator, Comment, Other
from src.typecode._vendor.pygments.util import get_int_opt, ClassNotFound
