...
from src.typecode._vendor.pygments.lexer import RegexLexer, bygroups, include, this, using, words
from src.typecode._vendor.pygments.token import Comment, Keyword, Literal, Name, Number, \
