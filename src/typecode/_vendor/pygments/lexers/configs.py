...
from src.typecode._vendor.pygments.lexer import ExtendedRegexLexer, RegexLexer, default, words, \
...
from src.typecode._vendor.pygments.lexers.shell import BashLexer
