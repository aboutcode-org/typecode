...
from src.typecode._vendor.pygments.lexer import RegexLexer, default, include, bygroups
from src.typecode._vendor.pygments.token import Comment, Keyword, Literal, Name, Number, Operator, \
