...
from src.typecode._vendor.pygments.lexer import RegexLexer, include, bygroups, using
from src.typecode._vendor.pygments.token import Text, Comment, Name, String, Number, \
