...
from src.typecode._vendor.pygments.lexer import RegexLexer, combined, words, include, bygroups
from src.typecode._vendor.pygments.token import Comment, Literal, Keyword, Name, Number, Operator, \
