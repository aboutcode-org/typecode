...
from src.typecode._vendor.pygments.lexer import RegexLexer, bygroups, default
from src.typecode._vendor.pygments.token import Operator, Comment, Keyword, Literal, Name, String, \
