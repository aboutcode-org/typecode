...
from src.typecode._vendor.pygments.lexer import RegexLexer, words, include, bygroups
from src.typecode._vendor.pygments.token import Comment, Whitespace, Operator, Keyword, Name, \
