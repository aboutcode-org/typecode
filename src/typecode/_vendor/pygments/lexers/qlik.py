...
from src.typecode._vendor.pygments.lexer import RegexLexer, include, bygroups, words
from src.typecode._vendor.pygments.token import Comment, Keyword, Name, Number, Operator, \
    Punctuation, String, Text
from src.typecode._vendor.pygments.lexers._qlik_builtins import OPERATORS_LIST, STATEMENT_LIST, \
