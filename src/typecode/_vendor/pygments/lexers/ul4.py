...
from src.typecode._vendor.pygments.lexer import RegexLexer, DelegatingLexer, bygroups, words, include
from src.typecode._vendor.pygments.token import Comment, Text, Keyword, String, Number, Literal, \
    Name, Other, Operator
from src.typecode._vendor.pygments.lexers.web import HtmlLexer, XmlLexer, CssLexer, JavascriptLexer
