...
from src.typecode._vendor.pygments.lexer import RegexLexer, words, bygroups, include
from src.typecode._vendor.pygments.token import Name, Text, Comment, Keyword, String, Punctuation, \
