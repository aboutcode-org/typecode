...
from src.typecode._vendor.pygments.lexer import bygroups, combined, default, do_insertions, include, \
...
class LassoLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.builtinshighlighting:
            from src.typecode._vendor.pygments.lexers._lasso_builtins import BUILTINS, MEMBERS
