...
from src.typecode._vendor.pygments.lexer import bygroups, inherit, words
from src.typecode._vendor.pygments.lexers import PrologLexer
from src.typecode._vendor.pygments.token import Operator, Keyword, Name, String, Punctuation
