...
from src.typecode._vendor.pygments.lexer import RegexLexer, include, bygroups, inherit, words, \
    default
...
from src.typecode._vendor.pygments.lexers import _mql_builtins
