...
from src.typecode._vendor.pygments.lexer import RegexLexer, bygroups, default, include, this, using
...
class VimLexer(RegexLexer):
    ...
    def __init__(self, **options):
        from src.typecode._vendor.pygments.lexers._vim_builtins import auto, command, option
        self._cmd = command
        self._opt = option
        self._aut = auto
