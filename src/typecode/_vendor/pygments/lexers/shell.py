...
from src.typecode._vendor.pygments.lexer import Lexer, RegexLexer, do_insertions, bygroups, \
    include, default, this, using, words, line_re
from src.typecode._vendor.pygments.token import Punctuation, Whitespace, \
