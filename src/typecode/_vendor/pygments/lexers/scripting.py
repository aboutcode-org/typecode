...
from typecode._vendor.pygments.lexer import RegexLexer, include, bygroups, default, combined, \
    words
...
class LuaLexer(RegexLexer):
    ...
    `disabled_modules`
        ...
        .. sourcecode:: pycon
            ...
            >>> from typecode._vendor.pygments.lexers._lua_builtins import MODULES
            >>> MODULES.keys()
