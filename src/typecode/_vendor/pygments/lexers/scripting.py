...
from src.typecode._vendor.pygments.lexer import RegexLexer, include, bygroups, default, combined, \
    words
...
from src.typecode._vendor.pygments.util import get_bool_opt, get_list_opt
...
def all_lua_builtins():
    from src.typecode._vendor.pygments.lexers._lua_builtins import MODULES
...
class LuauLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.include_luau_builtins:
            from src.typecode._vendor.pygments.lexers._luau_builtins import LUAU_BUILTINS
            self._builtins.update(LUAU_BUILTINS)
        if self.include_roblox_builtins:
            from src.typecode._vendor.pygments.lexers._luau_builtins import ROBLOX_BUILTINS
