...
from typecode._vendor.pygments.lexer import RegexLexer, bygroups, default
from typecode._vendor.pygments.token import Keyword, Punctuation, String, Number, Operator, Generic, \
