...
from src.typecode._vendor.pygments.lexer import RegexLexer, words, include, bygroups, default
from src.typecode._vendor.pygments.token import (Comment, Keyword, Name, Number, Punctuation, String,
                            Whitespace)
