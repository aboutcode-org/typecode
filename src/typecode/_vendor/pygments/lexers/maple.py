...
from src.typecode._vendor.pygments.lexer import words, bygroups, ExtendedRegexLexer
from src.typecode._vendor.pygments.token import Comment, Name, String, Whitespace, Operator, Punctuation, Number, Keyword
