...
from src.typecode._vendor.pygments.lexer import RegexLexer, bygroups, words, include
from src.typecode._vendor.pygments.token import Text, Comment, Punctuation, Operator, Keyword, Name, Number, Whitespace, Literal, String
