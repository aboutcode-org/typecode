...
from src.typecode._vendor.pygments.lexer import bygroups, default, include, inherit
from src.typecode._vendor.pygments.lexers.javascript import JavascriptLexer, TypeScriptLexer
from src.typecode._vendor.pygments.token import Name, Operator, Punctuation, String, Text, \
    Whitespace
