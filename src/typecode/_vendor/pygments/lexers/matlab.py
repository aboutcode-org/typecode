...
from src.typecode._vendor.pygments.lexer import Lexer, RegexLexer, bygroups, default, words, \
    do_insertions, include
from src.typecode._vendor.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Generic, Whitespace

from src.typecode._vendor.pygments.lexers import _scilab_builtins
