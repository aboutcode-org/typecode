...
from src.typecode._vendor.pygments.lexer import RegexLexer, words, include
from src.typecode._vendor.pygments.token import Punctuation, Keyword, Whitespace, Name, Comment, \
    Operator, Number
