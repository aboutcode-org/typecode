...
from src.typecode._vendor.pygments.lexer import RegexLexer, bygroups, include
from src.typecode._vendor.pygments.token import String, Punctuation, Whitespace, Name, Operator, \
