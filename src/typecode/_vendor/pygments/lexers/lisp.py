...
from src.typecode._vendor.pygments.lexer import RegexLexer, include, bygroups, words, default
...
from src.typecode._vendor.pygments.lexers._scheme_builtins import scheme_keywords, scheme_builtins
...
class CommonLispLexer(RegexLexer):
    ...
    def __init__(self, **options):
        from src.typecode._vendor.pygments.lexers._cl_builtins import BUILTIN_FUNCTIONS, \
